...
const db = postgres_1.default.getInstance().getDB();
class HackathonModel {
    ...
    async getTracksForHackathon(hackathonId) {
        try {
    ...
    async getSubmissionsForHackathon(hackathonId, trackId) {
        try {
    ...
    async createReview(projectId, hackerId, review) {
        try {
            // Insert review
    ...
    async getSponsorsForHackathon(hackathonId) {
        try {
    ...
    async getSubmissionCountForHackathon(hackathonId) {
        try {
...
exports.default = new HackathonModel();
